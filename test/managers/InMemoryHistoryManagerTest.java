...
class InMemoryHistoryManagerTest {
    ...
    void setUp() {
        ...
        task2.setId(2);
        Task task3 = new Task("title", "description", TaskStatus.NEW,  LocalDateTime.now(), 5);
        task3.setId(3);
        Task task4 = new Task("title", "description", TaskStatus.NEW,  LocalDateTime.now(), 5);
        task4.setId(4);
        Task task5 = new Task("title", "description", TaskStatus.NEW,  LocalDateTime.now(), 5);
        task5.setId(5);
        Task task6 = new Task("title", "description", TaskStatus.NEW,  LocalDateTime.now(), 5);
        task6.setId(6);
        Epic epic1 = new Epic("title", "description");
        epic1.setId(7);
        Epic epic2 = new Epic("title", "description");
        epic2.setId(8);
        SubTask subTask1 = new SubTask("title", "description",TaskStatus.NEW,  LocalDateTime.now(), 5,999);
        subTask1.setId(9);
        SubTask subTask2 = new SubTask("title", "description",TaskStatus.NEW,  LocalDateTime.now(), 5,999);
        subTask2.setId(10);
        SubTask subTask3 = new SubTask("title", "description",TaskStatus.NEW,  LocalDateTime.now(), 5,999);
        subTask3.setId(11);
